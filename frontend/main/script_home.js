...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (isAuthenticated && currentUser) {
        ...
        if (navGasto) {
            navGasto.style.display = (currentUser.username === 'jpvaldes' || currentUser.username === 'gobernador' || currentUser.name === 'Gob. JP. Valdes') ? 'none' : 'block';
        }
        ...
        if (navGastoMobile) {
            navGastoMobile.style.display = (currentUser.username === 'jpvaldes' || currentUser.username === 'gobernador' || currentUser.name === 'Gob. JP. Valdes') ? 'none' : 'block';
        }
